...
import com.example.uisadmin.NoticeData;
import com.example.uisadmin.R;
import com.example.uisadmin.UploadNotice;
...
public class AddTeacher extends AppCompatActivity {
    ...
    private EditText addTeacherName, addTeacherEmail, addTeacherPost, addTeacherContact;
    private Spinner addTeacherCategory;
    private Button addTeacherBtn;
    private final int REQ = 1;
    private Bitmap bitmap = null;
    private String category;
    private String name, email, post, contact, downloadUrl = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category", "Pre-Primary", "Primary", "Secondary"};
    ...
    private void checkValidation() {
        ...
        if (name.isEmpty()){
            ...
            addTeacherContact.setError("Empty");
            addTeacherContact.requestFocus();
    ...
    private void insertData() {
        ...
        TeacherData teacherData = new TeacherData(name, email, post, contact, downloadUrl, uniqueKey);
