...
public class DeleteNoticeActivity extends AppCompatActivity {
    ...
    private RecyclerView deletNoticeRecycler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deletNoticeRecycler = findViewById(R.id.deletNoticeRecycler);
        progressBar = findViewById(R.id.progressBar);
        reference = FirebaseDatabase.getInstance().getReference("Notice");


        deletNoticeRecycler.setLayoutManager(new LinearLayoutManager(this));
        deletNoticeRecycler.setHasFixedSize(true);
    ...
    private void getNotice() {
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                deletNoticeRecycler.setAdapter(adapter);
            }
